...
//       sendModel.dateBegin = moment(data.period[0]).format('DD.MM.YYYY');
//       sendModel.dateEnd = moment(data.period[1]).format('DD.MM.YYYY');
//     }
//     if (data.documentDate)
//       sendModel.documentDate = moment(data.documentDate).format('DD.MM.YYYY');
//
//     if (data.contractAlternation) {
//       sendModel.contractAlternation = {
