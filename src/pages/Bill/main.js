...
export default class BillsTable extends Component  {
    ...
    fcolumn: [
      {
        ...
        dataIndex: 'periodSection',
        isVisible: true,
        width : 200,
        order: 1,
        key: 'periodSection.name',
        render: (item) => {
          if (item){
            return item ? (item.dateBegin+" - "+item.dateEnd) : "";
          }
        },
      },
      {
  ...
  render = () => {
    ...
    return (
      <PageHeaderWrapper title={formatMessage({ id: 'menu.contract.bills' })}>
