...
import { ContragentsPage, SpecPage, InfoPage, DogovorPage } from '../CounterAgent/TabPagesView';
import styles from '../CounterAgent/CounterAgent.less';
...
export default class viewcontract extends Component {
  ...
  render = () => {
    ...
    return (<PageHeaderWrapper title={formatMessage({ id: 'menu.contract.contracts.add' })}>
      <Card
        headStyle={{ padding: 0 }}
        title={''}
